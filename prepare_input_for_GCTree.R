...
# ***** examples input args, for debugging mode
path.to.mixcr.output="/home/hieunguyen/CRC1382/src_2023/bcrtree_pipeline/output/mixcr_pipeline_output" # input to this = output of mixcr
path.to.save.fasta="/home/hieunguyen/CRC1382/src_2023/bcrtree_pipeline/output/fasta_for_GCTree_pipeline"
path.to.save.output="/home/hieunguyen/CRC1382/src_2023/bcrtree_pipeline/output/processed_output"
